...
public class TXTPedimentoConsultas extends Conexion{
    ...
    public ArrayList listarAño(){
        ...
        String sql = "Select año from txtpedimento group by año";
    ...
    public ArrayList listarBimestre(){
        ...
        String sql = "Select bimestre from txtpedimento group by bimestre order by bimestre ASC";
    ...
    public ArrayList listarRegimen(){
        ...
        String sql = "Select regimen from txtpedimento group by regimen";
